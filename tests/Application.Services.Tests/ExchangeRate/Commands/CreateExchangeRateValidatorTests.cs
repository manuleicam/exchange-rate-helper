namespace Application.Services.Tests.ExchangeRate.Commands
{
    ...
    public class CreateExchangeRateValidatorTests
    {
    
        private readonly CreateExchangeRateValidator createExchangeRateValidator;

        public CreateExchangeRateValidatorTests()
        {
            this.createExchangeRateValidator = new CreateExchangeRateValidator();
        }
        ...
        public void Validator_AllValid_NoValidationErrors()
        {
            ...
            var createExchangeRate = new CreateExchangeRate(fromCurrency,toCurrency,1.1,1.1,1.1);
            
            // Act
            var validationResult = this.createExchangeRateValidator.TestValidate(createExchangeRate);
